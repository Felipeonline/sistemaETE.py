...
def coreList(request):
    ...
    return render(request, 'core/sistema_armazenamento.html',{'core':core})

def gradeamento_view(request):
    # Lógica da página do sistema de gradeamento
    return render(request, 'dashbord/gradeamento_view.html')

def coreList(request):
    core= core.objects.all()
    return render(request, 'core/sistema_gradeamento.html',{'core':core})
